...
public class CheckEvasionEvent implements CombatEvent {
    ...
    @Override
    public boolean execute(ShipInstance shipInstance, Shot shot) {
        ...
        final int evasion = shipInstance.getHullStat(StatType.MANEUVERABILITY);
        ...
        logger.isHit(shipInstance, targetIsHit, totalAccuracy, evasion, addedAccuracy, shot.weaponName);
        return targetIsHit;
    }
}
