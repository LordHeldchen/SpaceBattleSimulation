...
public abstract class BattleLogger {
    ...
    public abstract void hasResupplied(ShipBlueprint ship, ShipBlueprint mothership);
    ...
    public abstract void takesHullDamage(ShipInstance ship, double remainingDamage, HullDamageLevel glancing, int hitStrength, int specificResistance,
            int threshold, String weaponName);

    // Destruction
    public abstract void explodes(ShipInstance shipInstance, double explodeChance, int hitStrength, double damageAmount, int calculatedValue, int containment,
            String weaponName);
